    ...
    >
      ...
      <div id="hero" data-section="hero">
        <HeroSplitTestimonial
          ...
          testimonials={[
            {
              name: "Premium Quality",              handle: "100% Real Fruit Ingredients",              testimonial: "Natural fruits transformed into delicious and practical snacks that preserve flavor and nutrition.",              rating: 5,
              imageSrc: "http://img.b2bpic.net/free-photo/confident-young-businesswoman-with-folded-arms_1262-1775.jpg",              imageAlt: "Premium quality seal"},
            {
              name: "Retail Success",              handle: "High Shelf Rotation",              testimonial: "Strong consumer demand and excellent retail margins make SNEKI the perfect product for your store.",              rating: 5,
              imageSrc: "http://img.b2bpic.net/free-photo/young-businesswoman-portrait-office_1262-1506.jpg",              imageAlt: "Retail success metric"},
            {
              name: "Convenient Packaging",              handle: "Easy to Stock & Display",              testimonial: "Attractive packaging and straightforward logistics ensure seamless integration into your retail environment.",              rating: 5,
              imageSrc: "http://img.b2bpic.net/free-photo/smiling-beautiful-middle-aged-business-woman_1262-3085.jpg",              imageAlt: "Convenient packaging"},
          ]}
